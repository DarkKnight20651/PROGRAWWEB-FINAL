  ...
  return (
    <div className='catra__whatiscatra section__margin'>
      <div className='catra__whatiscatra-feature '>
        <Feature title="Qué es catra" text=" CATRA se distingue por ofrecer cursos y asesoría de alta calidad tanto para individuos como para empresas y entidades gubernamentales a nivel nacional." />
      </div>
